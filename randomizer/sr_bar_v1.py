...
class Randomizer(BaseRandomizer):
    def __init__(self, **kwargs):
        ...
        #Yitaek 
        self.cap_friction_randomization_lower = cfg.get("cab_friction_lower")
        self.cap_friction_randomization_upper = cfg.get("cab_friction_upper")

        #print("self.cab_friction_lower",self.cap_friction_randomization_lower)
        #print("self.cab_friction_upper",self.cap_friction_randomization_upper)

        self.object_param_random_scales["cap_friction"] = (
            self.cap_friction_randomization_lower,
            self.cap_friction_randomization_upper,
        )

        # Virtual_torque 
        self.virtual_torque_rate = cfg.get("virtual_torque_rate")
    ...
    def get_virtual_torque_setup(self):
        return self.virtual_torque_rate
